...
ARTIFACT_SPECS = [
    ...
    ArtifactSpec(
        ...
        scope="unit-task",
        family="runtime",
        schema_path="contracts/canonical/schemas/runtime/developer-report.schema.json",
        template_path="contracts/canonical/templates/runtime/developer-report.template.json",
