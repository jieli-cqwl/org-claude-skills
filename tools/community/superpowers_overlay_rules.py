...
SUPERPOWERS_FRONTMATTER_LINES = {
    ...
    "skills/using-git-worktrees/SKILL.md": ["description: Use when the small-chain needs an isolated workspace before implementation — creates git worktrees with safety verification"],
    ...
    "skills/subagent-driven-development/SKILL.md": ["description: Use after writing-plans produces tasks.md and plan.md to execute small-chain implementation via subagents"],
