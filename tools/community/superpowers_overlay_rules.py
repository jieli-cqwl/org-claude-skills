...
SUPERPOWERS_FRONTMATTER_LINES = {
    ...
    "skills/using-git-worktrees/SKILL.md": ["description: Use after implementation-router returns decision=serial and the small-chain needs an isolated workspace before implementation."],
    ...
    "skills/subagent-driven-development/SKILL.md": ["description: Use after implementation-router returns decision=serial to execute small-chain implementation via subagents."],
