...
assert_section_present "$DIRECTOR_SKILL" "## 流程" '"5 风险与 Phase 规划" -> "6 冻结与交接"' "director flow sequence"
assert_section_present "$DIRECTOR_SKILL" "## 流程" '暂停 / 阻断 / 不做' "director flow diagram"
assert_section_present "$DIRECTOR_SKILL" "## 流程细节" '### 5\. 风险与 Phase 规划' "director flow details"
...
assert_section_present "$DIRECTOR_SKILL" "## 流程细节" '### 1\. 事实与证据建图' "director flow details"
...
assert_section_present "$DIRECTOR_SKILL" "## 流程细节" '建立分级证据图' "director evidence map"
assert_section_present "$DIRECTOR_SKILL" "## 流程细节" '最会改变根问题判断的关键假设' "director evidence map"
assert_section_present "$DIRECTOR_SKILL" "## HARD-GATE" '任一环节可以暂停、阻断或不做' "director baseline gate"
