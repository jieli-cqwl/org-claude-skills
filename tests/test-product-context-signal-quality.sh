...
AUDIT_LOOP_RECORD="$ROOT/docs/archive/product-context-signal-cleanup-20260416/context-signal-audit-10-rounds.md"
DESIGN_DOC="$ROOT/docs/archive/product-context-signal-cleanup-20260416/design.md"
