...
assert_section_present "$DIRECTOR_SKILL" "## The Process" '项目现状、已有文档、contracts、历史需求' "director silent-scan inputs"
assert_section_present "$DIRECTOR_SKILL" "## The Process" '候选线索、来源和冲突点' "director silent-scan outputs"
...
assert_section_present "$DIRECTOR_SKILL" "## The Process" '回到 Checklist 中尚未完成的事项，继续推进基线确认' "director focused co-creation"
...
assert_section_present "$DIRECTOR_SKILL" "## Role Boundary" '确认前只形成候选判断' "director pending-baseline wording"
