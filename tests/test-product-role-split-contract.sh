...
DIRECTOR_CONVERSATION_GUIDE="$PRODUCT_DIRECTOR_ROOT/references/conversation-guide.md"
...
assert_present 'review_conclusion / issue_ledger' "$PRODUCT_MANAGER_ROOT/SKILL.md"
...
assert_present '主导共创' "$DIRECTOR_CONVERSATION_GUIDE"
assert_present '先给出最佳实践草案、推荐选项和裁决理由' "$DIRECTOR_CONVERSATION_GUIDE"
assert_present '用户只需要选择、修正或补充业务事实' "$DIRECTOR_CONVERSATION_GUIDE"
