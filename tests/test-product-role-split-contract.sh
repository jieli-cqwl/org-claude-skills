...
MANAGER_REVIEW_TEMPLATE="$ROOT/shared/skills/product-manager/references/templates/review-template.md"
...
assert_present 'required: \[brief\.md, review\.md, "phase-\{N\}/prd\.md", "phase-\{N\}/units/UNIT-\*\.md"\]' "$CHAIN_CONTRACT"
...
assert_present 'review\.md' "$PRODUCT_MANAGER_ROOT/SKILL.md"
...
assert_present 'REVIEW_FILE="\$FEATURE_DIR/review\.md"' "$PRODUCT_MANAGER_CHECK"
