...
assert_present '提出裁决问题.*references/conversation-guide\.md|references/conversation-guide\.md.*一个共创收口动作' "$PRODUCT_DIRECTOR_ROOT/SKILL.md"
...
assert_present '最佳实践推荐问题框架' "$DIRECTOR_PROBLEM_GUIDE"
assert_present '请确认是否适配你的业务，或修正关键事实' "$DIRECTOR_PROBLEM_GUIDE"
assert_present '不得把方法论最佳实践拆成选项让用户判断' "$DIRECTOR_PROBLEM_GUIDE"
