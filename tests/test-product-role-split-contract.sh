...
assert_present '^allowed-tools: .*Agent' "$PRODUCT_MANAGER_ROOT/SKILL.md"
assert_present '^allowed-tools: .*Bash' "$PRODUCT_MANAGER_ROOT/SKILL.md"
assert_absent 'TeamCreate' "$PRODUCT_MANAGER_ROOT/SKILL.md"
assert_present 'product-manager/scripts/completion_check\.sh' "$PRODUCT_MANAGER_ROOT/SKILL.md"
