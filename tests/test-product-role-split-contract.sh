...
assert_present 'brief\.md#前置约束-con-001' "$DIRECTOR_BRIEF_TEMPLATE"
...
assert_present 'artifact: product-manager-review\.md' "$CHAIN_CONTRACT"
assert_absent 'artifact: review\.md|required: \[brief\.md, review\.md|required: \[brief\.md, product-manager-review\.md' "$CHAIN_CONTRACT"
...
assert_present 'product-manager-review\.md' "$PRODUCT_MANAGER_ROOT/SKILL.md"
...
assert_present 'REVIEW_FILE="\$FEATURE_DIR/product-manager-review\.md"' "$PRODUCT_MANAGER_CHECK"
assert_present 'product-artifacts\.yaml' "$PRODUCT_MANAGER_CHECK"
