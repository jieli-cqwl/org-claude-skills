...
DIRECTOR_D_S2="$PRODUCT_DIRECTOR_ROOT/references/d-s2-problem-clarification.md"
...
test -f "$DIRECTOR_D_S2" || fail "missing product-director D-S2 reference: $DIRECTOR_D_S2"
...
assert_present '主导共创' "$DIRECTOR_D_S2"
assert_present '问题框架或 2-3 个选项' "$DIRECTOR_D_S2"
assert_present '请确认/选择/修正' "$DIRECTOR_D_S2"
