...
install_test_assert_file_exists "$home_dir/.claude/skills/obsidian-cli/SKILL.md" "claude runtime should include obsidian-cli"
install_test_assert_file_contains "$home_dir/.claude/skills/obsidian-cli/SKILL.md" "disable-model-invocation: true" "claude obsidian-cli should be manual-only"
install_test_assert_file_exists "$home_dir/.claude/skills/obsidian-markdown/SKILL.md" "claude runtime should include obsidian-markdown"
install_test_assert_file_contains "$home_dir/.claude/skills/obsidian-markdown/SKILL.md" "disable-model-invocation: true" "claude obsidian-markdown should be manual-only"
...
install_test_assert_file_exists "$codex_skills_dir/obsidian-cli/SKILL.md" "codex runtime should include obsidian-cli"
install_test_assert_file_contains "$codex_skills_dir/obsidian-cli/agents/openai.yaml" "allow_implicit_invocation: false" "codex obsidian-cli should disable implicit invocation"
install_test_assert_file_exists "$codex_skills_dir/obsidian-markdown/SKILL.md" "codex runtime should include obsidian-markdown"
install_test_assert_file_contains "$codex_skills_dir/obsidian-markdown/agents/openai.yaml" "allow_implicit_invocation: false" "codex obsidian-markdown should disable implicit invocation"
