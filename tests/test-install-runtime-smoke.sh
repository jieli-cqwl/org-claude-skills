...
install_test_assert_file_not_contains "$home_dir/.claude/CLAUDE.md" "{{RUNTIME_HOME}}" "claude entry should render runtime paths"
install_test_assert_file_not_contains "$home_dir/.codex/AGENTS.md" "{{RUNTIME_HOME}}" "codex entry should render runtime paths"
...
install_test_assert_file_contains "$home_dir/.codex/hooks.json" "$home_dir/.codex/hooks/managed/codex_subagent_dispatch_guard.py" "codex hooks should include subagent dispatch guard"
