...
assert_preflight_accepts_test_obligations_schema() {
  ...
  jq '.runtime_status = "BLOCKED" | .blocked_reason = "fixture verifies blocked developer input routing"' "$phase_dir/unit-1/tasks/T1/developer-report.json" >"$phase_dir/unit-1/tasks/T1/developer-report.tmp.json"
