...
- `design`: canonical `design` artifact，必须包含协作过程摘要、架构决策、候选方案取舍、运行时事实、接口输入/输出/错误码、模块边界、数据架构、质量属性、验证映射、UNIT 覆盖、影响面、风险响应、迁移、验证、回滚、review closure 和 final confirmation。
