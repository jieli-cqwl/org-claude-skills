...
[ -f "$CODEX_SKILLS_DIR/skill-creator/SKILL.md" ] || fail "skill-creator Anthropic source should install"
[ ! -e "$CODEX_SKILLS_DIR/skill-creator/agents/openai.yaml" ] || fail "skill-creator Anthropic adapter should not exist"
