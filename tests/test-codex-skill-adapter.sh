...
grep -Fq 'Use after small-chain-execution-router returns decision=serial to execute small-chain implementation via subagents.' "$TMP_HOME/.codex/skills/subagent-driven-development/SKILL.md" || fail "subagent-driven-development codex description should require router serial decision"
grep -Fq 'description: "Use after small-chain-execution-router returns decision=serial when small-chain work needs an isolated git worktree."' "$TMP_HOME/.codex/skills/using-git-worktrees/SKILL.md" || fail "using-git-worktrees codex description should require router serial decision"
