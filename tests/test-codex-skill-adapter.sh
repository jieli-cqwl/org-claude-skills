...
[ -f "$CODEX_SKILLS_DIR/bb-browser/agents/openai.yaml" ] || fail "bb-browser skills.sh adapter should install"
[ -f "$CODEX_SKILLS_DIR/humanizer-zh/agents/openai.yaml" ] || fail "humanizer-zh skills.sh adapter should install"
[ -f "$CODEX_SKILLS_DIR/notebooklm/agents/openai.yaml" ] || fail "notebooklm skills.sh adapter should install"
...
[ ! -f "$CODEX_SKILLS_DIR/self-improving-agent/agents/openai.yaml" ] || fail "self-improving-agent should not expose a Codex adapter"
