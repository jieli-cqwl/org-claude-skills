...
assert_present 'docs/\{feature\}/brief\.md' "$DIRECTOR_OUTPUT_CONTRACT"
assert_present 'references/templates/brief-template\.md' "$DIRECTOR_OUTPUT_CONTRACT"
...
assert_present 'docs/\{feature\}/brief\.md' "$MANAGER_OUTPUT_CONTRACT"
assert_present 'docs/\{feature\}/phase-\{N\}/prd\.md' "$MANAGER_OUTPUT_CONTRACT"
assert_present 'docs/\{feature\}/phase-\{N\}/units/UNIT-\*\.md' "$MANAGER_OUTPUT_CONTRACT"
assert_present 'docs/\{feature\}/review\.md' "$MANAGER_OUTPUT_CONTRACT"
assert_present 'references/templates/review-template\.md' "$MANAGER_OUTPUT_CONTRACT"
