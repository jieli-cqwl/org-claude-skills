...
assert_present 'contracts/canonical/schemas/runtime/qa-result.schema.json' "$QA_SKILL" "qa skill"
assert_present 'contracts/canonical/templates/runtime/qa-result.template.json' "$QA_SKILL" "qa skill"
