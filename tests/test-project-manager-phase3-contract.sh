...
PM_QA_TEMPLATE="$ROOT/shared/skills/project-manager/references/templates/qa-report-template.md"
...
grep -Fq 'Delivery Kickoff' "$PM_SKILL" || fail "project-manager skill missing delivery kickoff stage"
grep -Fq 'goal closure' "$PM_SKILL" || fail "project-manager skill missing goal closure requirement"
grep -Fq 'developer_report_ref' "$PM_SKILL" || fail "project-manager skill missing one-source evidence reference"
grep -Fq 'COMPLEXITY_DRIFT' "$PM_SKILL" || fail "project-manager skill missing deviation trigger vocabulary"
...
grep -Fq "qa/references/templates/qa-report-template.md" "$PM_SKILL" || fail "project-manager skill should reference qa authoritative template"
...
grep -Fq 'browser_required' "$PM_SKILL" || fail "project-manager skill missing browser_required dispatch rule"
...
test ! -e "$PM_QA_TEMPLATE" || fail "project-manager should not own a duplicate qa template"
...
grep -Fq 'developer_report_ref' "$ROOT/shared/skills/project-manager/references/templates/dev-report-template.md" || fail "dev-report template missing developer_report_ref field"
grep -Fq 'deviation_trigger' "$ROOT/shared/skills/project-manager/references/templates/dev-report-template.md" || fail "dev-report template missing deviation trigger field"
grep -Fq 'control_action' "$ROOT/shared/skills/project-manager/references/templates/dev-report-template.md" || fail "dev-report template missing control action field"
...
grep -Fq 'QAR-' "$ROOT/shared/skills/project-manager/references/templates/waivers-template.md" || fail "waivers template missing QAR linkage"
grep -Fq '补偿控制' "$ROOT/shared/skills/project-manager/references/templates/waivers-template.md" || fail "waivers template missing compensating control field"
grep -Fq '到期时间' "$ROOT/shared/skills/project-manager/references/templates/waivers-template.md" || fail "waivers template missing expiry field"
