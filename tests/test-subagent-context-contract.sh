...
assert_present '主 Agent.*转写' "$ROOT/shared/skills/design/projections/adr-spec.md"
...
ROUTING_REF="$ROOT/shared/skills/delivery-owner/references/routing-and-packet.md"
assert_absent 'synthesis-template\.md|subagent-recovery-contract|context-noise-metrics' "$ROUTING_REF"
assert_present 'task packet' "$ROUTING_REF"
assert_present 'role executor' "$ROOT/shared/skills/delivery-owner/SKILL.md"
