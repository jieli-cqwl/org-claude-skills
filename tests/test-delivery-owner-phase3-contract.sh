...
grep -Fq 'plan_version_ref' "$ROOT/docs/delivery-owner-role-20260411/pilot-evidence.md" || fail "pilot evidence contract missing plan_version_ref"
grep -Fq 'acceptance_summary_ref' "$ROOT/docs/delivery-owner-role-20260411/pilot-evidence.md" || fail "pilot evidence contract missing acceptance_summary_ref"
grep -Fq 'qa_report_ref' "$ROOT/docs/delivery-owner-role-20260411/pilot-evidence.md" || fail "pilot evidence contract missing qa_report_ref"
grep -Fq 'fresh_proving_output_ref' "$ROOT/docs/delivery-owner-role-20260411/pilot-evidence.md" || fail "pilot evidence contract missing fresh_proving_output_ref"
grep -Fq 'mixed_version_rejected' "$ROOT/docs/delivery-owner-role-20260411/pilot-evidence.md" || fail "pilot evidence contract missing mixed-version rejection rule"
grep -Fq 'plan_version_ref' "$ROOT/tests/test-delivery-owner-rollout-gate.sh" || fail "rollout gate test missing plan_version_ref coverage"
grep -Fq 'fresh_proving_output_ref' "$ROOT/tests/test-delivery-owner-rollout-gate.sh" || fail "rollout gate test missing fresh_proving_output_ref coverage"
grep -Fq 'mixed_version_rejected' "$ROOT/tests/test-delivery-owner-rollout-gate.sh" || fail "rollout gate test missing mixed-version rejection coverage"
