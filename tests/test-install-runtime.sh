...
printf 'retired system debugging reference\n' > "$home_dir/.codex/reference/系统调试.md"
printf 'retired fullstack reference\n' > "$home_dir/.codex/reference/全栈开发.md"
...
install_test_assert_path_absent "$home_dir/.codex/reference/系统调试.md" "retired system debugging reference residue should be removed"
install_test_assert_path_absent "$home_dir/.codex/reference/全栈开发.md" "retired fullstack reference residue should be removed"
...
archive_path="$(find "$state_root/codex/unexpected-artifacts" \( -type f -o -type l \) -path '*/reference/系统调试.md' | head -1)"
[ -n "$archive_path" ] || install_test_fail "retired system debugging reference residue should be archived"
archive_path="$(find "$state_root/codex/unexpected-artifacts" \( -type f -o -type l \) -path '*/reference/全栈开发.md' | head -1)"
[ -n "$archive_path" ] || install_test_fail "retired fullstack reference residue should be archived"
...
install_test_assert_path_absent "$home_dir/.codex/reference/系统调试.md" "codex uninstall should not restore retired system debugging reference residue"
install_test_assert_path_absent "$home_dir/.codex/reference/全栈开发.md" "codex uninstall should not restore retired fullstack reference residue"
