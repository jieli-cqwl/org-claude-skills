...
GRADER_DIRECTOR_FIRST_TURN="$ROOT/tools/eval/graders/product-director-first-turn-grader.md"
...
test -f "$GRADER_DIRECTOR_FIRST_TURN" || fail "missing product-director first-turn grader: $GRADER_DIRECTOR_FIRST_TURN"
...
assert_present 'tools/eval/graders/product-director-first-turn-grader\.md' "$SCENARIO_DIRECTOR_P2"
...
assert_present 'grading-product-director-first-turn\.json' "$SCENARIO_DIRECTOR_P2"
...
assert_present 'graders/product-director-first-turn-grader\.md' "$CHECK_OUT"
