...
assert_present '每轮回应结构' "$CONVERSATION_GUIDE"
assert_present '业务事实回应处理' "$CONVERSATION_GUIDE"
assert_present '不同环节回应方式' "$CONVERSATION_GUIDE"
...
assert_present '探索深度选择' "$CONVERSATION_GUIDE"
assert_present '冻结前检查' "$CONVERSATION_GUIDE"
