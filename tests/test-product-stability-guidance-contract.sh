...
assert_present 'contracts/canonical/templates/planning/director/brief\.template\.json' "$OUTPUT_CONTRACT"
assert_present 'contracts/canonical/templates/planning/director/phase-prd\.template\.json' "$OUTPUT_CONTRACT"
