...
assert_present '验证关键业务假设.*references/conversation-guide\.md|references/conversation-guide\.md.*共创回合协议' "$DIRECTOR"
...
assert_present '验证关键业务假设.*references/conversation-guide\.md|references/conversation-guide\.md.*共创回合协议' "$MANAGER"
