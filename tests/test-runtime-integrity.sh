...
test -f "$TMP_HOME/.claude/skills/hv-analysis/SKILL.md" || fail "missing ~/.claude/skills/hv-analysis/SKILL.md"
...
for skill in ai-cli-updater h5 skill-harness feishu-docs hv-analysis algorithmic-art brand-guidelines canvas-design darwin-skill ui-ux-pro-max doc-coauthoring docx internal-comms mcp-builder pdf pptx slack-gif-creator theme-factory web-artifacts-builder xlsx agent-browser; do
...
test -f "$TMP_HOME/.codex/skills/hv-analysis/SKILL.md" || fail "missing ~/.codex/skills/hv-analysis/SKILL.md"
