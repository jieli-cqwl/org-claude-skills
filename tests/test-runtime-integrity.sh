...
for skill in ai-cli-updater h5 skill-harness feishu-docs deep-research algorithmic-art brand-guidelines canvas-design darwin-skill ui-ux-pro-max doc-coauthoring docx internal-comms mcp-builder pdf pptx slack-gif-creator theme-factory web-artifacts-builder xlsx agent-browser; do
