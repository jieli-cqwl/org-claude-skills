...
INPUT="$ROOT/tests/fixtures/stage1-agent-delivery-operating-system/dry-runs/do-002/input.md"
OUTPUT="$ROOT/tests/fixtures/stage1-agent-delivery-operating-system/dry-runs/do-002/delivery-owner/output.md"
EVALUATOR="$ROOT/tests/fixtures/stage1-agent-delivery-operating-system/dry-runs/do-002/delivery-owner/evaluator-output.md"
