...
assert_present '^## 上下文分担$' "$DESIGN_SKILL"
assert_present 'baseline_packet' "$DESIGN_SKILL"
assert_present 'runtime_fact_packet' "$DESIGN_SKILL"
assert_present 'decision_packet' "$DESIGN_SKILL"
assert_present 'review_packet' "$DESIGN_SKILL"
assert_present 'packet 只能作为证据或候选项' "$DESIGN_SKILL"
