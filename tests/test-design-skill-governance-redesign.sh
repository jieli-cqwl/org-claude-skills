...
assert_present 'reviewer.*审.*自检后的设计产物|三视角.*审.*自检后的设计产物' "$DESIGN_SKILL"
...
assert_present 'S10 reviewer 必须审 owner 自检后的设计产物并回显同一个 digest|self_checked_design_review_digest' "$DESIGN_EVALS"
