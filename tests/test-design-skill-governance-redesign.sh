...
assert_present '候选设计包通过 TeamCreate 输入传递，不落盘到 Phase 目录' "$DESIGN_SKILL"
...
assert_present 'tool_input.file_path=\\"docs/sample-feature/phase-1/design\.json\\"' "$DESIGN_EVALS"
