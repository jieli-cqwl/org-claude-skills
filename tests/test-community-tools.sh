...
assert "obsidian-cli" in skills_sh.SKILL_SOURCES
assert skills_sh.SKILL_SOURCES["obsidian-cli"]["source_name"] == "skills_sh_kepano_obsidian_skills"
assert skills_sh.SKILL_SOURCES["obsidian-cli"]["relative_path"].as_posix() == "skills/obsidian-cli"
assert skills_sh.SKILL_SOURCES["obsidian-cli"]["codex_adapter"] is False
assert "obsidian-markdown" in skills_sh.SKILL_SOURCES
assert skills_sh.SKILL_SOURCES["obsidian-markdown"]["source_name"] == "skills_sh_kepano_obsidian_skills"
assert skills_sh.SKILL_SOURCES["obsidian-markdown"]["relative_path"].as_posix() == "skills/obsidian-markdown"
assert skills_sh.SKILL_SOURCES["obsidian-markdown"]["codex_adapter"] is False
...
assert "skills_sh_kepano_obsidian_skills" in locks
PY
