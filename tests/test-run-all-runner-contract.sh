...
assert_contains "bash $ROOT/tests/test-skill-harness-mvp-boundary.sh" "$full_plan" "full plan"
...
assert_contains "bash $ROOT/tests/test-skill-harness-mvp-boundary.sh" "$quick_plan" "quick plan"
