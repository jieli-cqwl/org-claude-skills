...
test -f "$TMP_HOME/.claude/skills/skill-optimizer/SKILL.md"
...
test -f "$TMP_HOME/.codex/skills/skill-optimizer/SKILL.md"
test -f "$TMP_HOME/.codex/skills/skill-optimizer/agents/openai.yaml"
