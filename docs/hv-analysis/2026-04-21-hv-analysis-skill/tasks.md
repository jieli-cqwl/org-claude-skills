...
- [x] T1 Add HV Analysis skill contract tests
  ...
  - Depends: -
  - Complexity: moderate
- [x] T2 Create `hv-analysis` skill source, references, and evals
...
- [x] T3 Add deterministic arxiv and PDF scripts with tests
  ...
  - Depends: T2
  - Complexity: moderate
- [x] T4 Integrate `hv-analysis` into Claude and Codex runtime installation
