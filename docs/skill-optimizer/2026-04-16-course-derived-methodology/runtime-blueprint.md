# skill-optimizer Runtime 蓝图

## 目的

本文件承载 `skill-optimizer` 的 Harness Engineering 细节。`design.md` 冻结方向和边界；本文件冻结 JSON artifact、schema、状态、validator、renderer 和 hook adapter 的工程合同。
