...
- [x] T1 Add adapter config, path helpers, and dry-run workspace planning
  ...
  - Depends: -
  - Complexity: moderate
- [x] T2 Implement existing-skill workspace snapshot and eval metadata generation
  ...
  - Depends: T1
  - Complexity: moderate
- [x] T3 Implement old/new execution, grading, benchmark, and review HTML generation
  ...
  - Depends: T2
  - Complexity: complex
- [x] T4 Implement trigger eval and description optimization wrapper
  ...
  - Depends: T1
  - Complexity: moderate
- [x] T5 Add repository tests and documentation for the Anthropic adapter
