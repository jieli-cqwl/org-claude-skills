#!/usr/bin/env python3
"""Run skill-auditor seed evals with manifest-approved commands."""
...
def validate_dataset(dataset: dict[str, Any], command_ids: set[str]) -> list[dict[str, Any]]:
    ...
    if dataset.get("artifact_type") != "skill-auditor-evals":
        fail("artifact_type must be skill-auditor-evals")
...
def build_results(dataset_path: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "artifact_id": "eval-results:skill-auditor",
        ...
        "verification_result_draft_input": {
            ...
            "artifact_ref": "eval-results:skill-auditor",
