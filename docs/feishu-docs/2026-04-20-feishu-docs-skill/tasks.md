...
- [ ] T1 Add Feishu Docs skill contract tests
  ...
  - Depends: -
  - Complexity: moderate
- [ ] T2 Create `feishu-docs` skill source and bundled references
  ...
  - Depends: T1
  - Complexity: moderate
- [ ] T3 Add deterministic Feishu CLI wrapper and wrapper tests
  ...
  - Depends: T2
  - Complexity: moderate
- [ ] T4 Integrate `feishu-docs` into Claude and Codex runtime installation
