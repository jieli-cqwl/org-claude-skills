# Project Manager Best-Practice Rebuild Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development to implement this plan task-by-task.

**Goal:** Rebuild `project-manager` from an execution-oriented delivery orchestrator into a team-usable Phase delivery owner with explicit kickoff, deviation governance, dynamic quality escalation, and goal-level closure.

**Architecture:** Keep the existing chain split across `tech-lead`, `project-manager`, `developer`, `qa`, and `test-design`, but redefine their authority boundaries and interaction contracts. Upgrade the chain at five layers together: role definitions, templates, completion checks, contract tests, and rollout readiness artifacts so the new behavior is not just described but enforced.
...
- Create: `docs/project-manager-role-20260411/authority-matrix.md`
...
1. [T1] Update `contracts/skill-chain.yaml` to reflect the target authority model.
   - Add or revise ownership language so `project-manager` is the execution-phase delivery owner, `tech-lead` remains the planning owner, `qa` remains independent quality judgment owner, and business risk acceptance stays outside PM.

2. [T1] Rewrite role sections in `shared/skills/project-manager/SKILL.md`, `shared/skills/tech-lead/SKILL.md`, `shared/skills/qa/SKILL.md`, and `shared/skills/developer/SKILL.md`.
...
3. [T1] Create `docs/project-manager-role-20260411/authority-matrix.md`.
   - Capture `Must Own / May Decide / Must Escalate / Forbidden` for each role.

4. [T1] Run authority-drift scans.
   - Run: `rg -n "交付负责人|计划 owner|风险接受|sign-off|release_recommendation|重计划|升级门禁" contracts shared/skills docs/project-manager-role-20260411`
...
- Create: `shared/skills/project-manager/references/kickoff-checklist.md`
- Test: `tests/test-project-manager-phase3-contract.sh`
- Test: `tests/test-skill-output-and-gate-contract.sh`

1. [T2] Add an explicit `Delivery Kickoff` stage to `shared/skills/project-manager/SKILL.md`.
...
2. [T2] Create `shared/skills/project-manager/references/kickoff-checklist.md`.
   - Define the exact kickoff checklist, output fields, and failure handling.

3. [T2] Upgrade `shared/skills/project-manager/scripts/completion_check.sh`.
...
Files:
- Modify: `shared/skills/project-manager/SKILL.md`
- Modify: `shared/skills/project-manager/references/dispatch-guide.md`
- Modify: `shared/skills/project-manager/references/templates/dev-report-template.md`
- Modify: `shared/skills/developer/SKILL.md`
- Test: `tests/test-skill-output-and-gate-contract.sh`

1. [T3] Add an explicit deviation-governance section to `shared/skills/project-manager/SKILL.md`.
...
5. [T3] Run drift searches and tests.
   - Run: `rg -n "complexity|shared_files|TWEAK|BREAK|BLOCKED|replan|deviation" shared/skills/project-manager shared/skills/developer`
...
- Modify: `shared/skills/project-manager/scripts/phase3-grade-matrix.sh`
- Modify: `tests/test-project-manager-phase3-contract.sh`

1. [T4] Keep `plan.md` as the baseline gate source but add escalation semantics in `project-manager/SKILL.md`.
...
- Create: `docs/project-manager-role-20260411/goal-evidence-model.md`
- Test: `tests/test-project-manager-phase3-contract.sh`

1. [T5] Define the goal-evidence model in `docs/project-manager-role-20260411/goal-evidence-model.md`.
...
3. [T5] Update `project-manager/SKILL.md`.
...
Files:
- Create: `docs/project-manager-role-20260411/quality-rubric.md`
- Create: `docs/project-manager-role-20260411/replay-scenarios.md`
- Modify: `docs/project-manager-role-20260411/tasks.md`
- Modify: `docs/project-manager-role-20260411/plan.md`
