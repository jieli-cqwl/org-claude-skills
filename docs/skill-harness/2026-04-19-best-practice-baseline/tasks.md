...
- [ ] T1 Build the `skill-harness` runtime entry and reference routing
  ...
  - Depends: -
  - Complexity: moderate
- [ ] T2 Add deterministic engineering gates and calibration fixtures
  ...
  - Depends: T1
  - Complexity: complex
- [ ] T3 Migrate install and runtime exposure to `skill-harness`
  ...
  - Depends: T1
  - Complexity: moderate
- [ ] T4 Archive old `skill-auditor` runtime source and update active references
  ...
  - Depends: T3
  - Complexity: complex
- [ ] T5 Verify and package the small-chain result
