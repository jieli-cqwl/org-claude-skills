...
- [x] T1 Contract inventory and schema/template target
  ...
  - Depends: -
  - Complexity: complex
- [ ] T2 Semantic validator for refs, gaps, and cross-UNIT obligations
  ...
  - Depends: T1
  - Complexity: complex
- [ ] T3 Completion gate fail-closed hardening
  ...
  - Depends: T1, T2
  - Complexity: complex
- [ ] T4 Active fixtures and phase validation cutover
  ...
  - Depends: T1, T2, T3
  - Complexity: complex
- [ ] T5 Skill SOP, projection, reviewer, and downstream consumer alignment
  ...
  - Depends: T1, T2, T3, T4
  - Complexity: complex
- [ ] T6 Behavior eval and lifecycle evidence upgrade
  ...
  - Depends: T5
  - Complexity: moderate
- [ ] T7 Contract-grade design producer/consumer ownership guard
  ...
  - Depends: -
  - Complexity: moderate
- [ ] T8 Final route, context, and targeted verification
