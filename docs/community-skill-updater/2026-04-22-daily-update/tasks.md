...
- [ ] T1 Skill contract, installation exposure, and runner coverage are locked by tests
...
- [ ] T2 Candidate lookup script reads source locks, excludes OpenSpec, and classifies update status
...
- [ ] T3 Update orchestration script isolates work, applies refs, invokes sync/validation/install commands, and preserves failure state
...
- [ ] T4 Skill instructions and conversation summary output match the automation workflow
...
- [ ] T5 Repository validation proves the updater integrates with current runtime conventions
