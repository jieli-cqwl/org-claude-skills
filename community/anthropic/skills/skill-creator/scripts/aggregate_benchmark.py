#!/usr/bin/env python3
"""Aggregate run grading files into benchmark summary statistics.

Usage: python aggregate_benchmark.py <benchmark_dir>

Supports eval directories directly under the benchmark directory or under runs/.
"""
