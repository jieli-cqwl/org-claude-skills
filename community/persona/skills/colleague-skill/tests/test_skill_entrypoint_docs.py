...
class SkillEntrypointDocsTest(unittest.TestCase):
    ...
    def test_readme_and_install_use_dot_skill_paths(self) -> None:
        ...
        self.assertIn("cross-host across four", readme.lower())
