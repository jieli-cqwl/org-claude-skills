...
> 📢 **Обновление 2026.04.28** — **Группа 10 WeChat запущена!** Заходи в сообщество dot-skill — делиться навыками, обсуждать фичи, обмениваться советами.
>
> <img src="../assets/wechat-group-qr-10.png" alt="QR-код группы WeChat dot-skill" width="240">
>
> QR обновляется каждые 7 дней (истекает 2026-05-05) — если истёк, пиши мне в Discord.
