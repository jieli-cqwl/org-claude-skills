...
> 📢 **Atualização 2026.04.28** — **Grupo 10 do WeChat no ar!** Venha curtir a comunidade dot-skill — compartilhe skills, discuta funcionalidades, troque dicas.
>
> <img src="../assets/wechat-group-qr-10.png" alt="QR do grupo WeChat dot-skill" width="240">
>
> O QR renova a cada 7 dias (expira em 2026-05-05) — se expirar, me chame no Discord.
