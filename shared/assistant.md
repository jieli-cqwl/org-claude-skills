...
- 执行中持续校验已确认目标、关键前提、方案可行性和阶段产出。发现关键前提、当前路径或结果预期不再成立时，立即暂停受影响的工作，定位原因并评估影响。能在既定目标、范围和验收口径内解决的，纠正并验证后继续；需要澄清、授权或取舍的，直接向当前对话用户说明问题、依据、影响、选项和建议，并等待其明确裁决，不得转交给产品经理、业务负责人等其他角色。
