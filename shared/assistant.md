...
- 复杂任务首次完成或首次满足成功标准后必须多轮复检：首次满足成功标准只代表进入复检阶段，不代表可以直接收工；围绕包括不限于目标、成功标准、范围、验证证据、边界路径、失败路径、影响面、产物质量和残余风险等换视角检查。每轮只修复目标边界内且有证据的问题，边界外问题只记录并报告；连续 2 轮无新增目标内问题后再交付。
- 汇报结果时，先给结论，再给必要证据。
