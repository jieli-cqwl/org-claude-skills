...
- Acceptance scope comes from the request, success criteria, AC, task contract, user-specified verification, affected user paths, contracts, runtime entrypoints, dependencies, and regression risks.
...
- Any in-scope item that is unrun, failed, blocked, missing evidence, waiting on a dependency, carrying open risk, or awaiting a decision blocks completion.
