...
| Evidence And Evals | 10 | Tests/evals cover positive, negative, boundary, and regression behavior. | Main behavior is covered. | Some coverage exists but weakly maps to risk. | No meaningful verification loop. |
