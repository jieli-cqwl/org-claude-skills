---
name: test-design-h
description: test-design 历史归档快照。Use only when explicitly asked to inspect the previous test-design implementation for comparison or migration reference.
eval-type: mixed
...
# /test-design-h -- test-design 历史归档快照

> Historical snapshot. Active workflow lives in `shared/skills/test-design`.
