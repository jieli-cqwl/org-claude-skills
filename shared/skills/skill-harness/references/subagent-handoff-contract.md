...
Read: Read active skill-harness audit output rules plus source archived after retirement at `docs/archive/skill-auditor/runtime-source-2026-04-19/references/subagent-handoff-contract.md`.
