...
Ownership evidence archived after retirement: `optimization-plan` consumes `docs/archive/skill-auditor/runtime-source-2026-04-19/schemas/optimization-plan.schema.json`; `verification-result` consumes `docs/archive/skill-auditor/runtime-source-2026-04-19/schemas/verification-result.schema.json`.
