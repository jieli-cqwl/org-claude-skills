...
Read: Read the active manifest plus the source archived after retirement at `docs/archive/skill-auditor/runtime-source-2026-04-19/references/permission-script-contract.md`.
