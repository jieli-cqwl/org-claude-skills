#!/usr/bin/env python3
"""Aggregate skill-optimizer runtime evidence into verification-result.json."""
...
def build(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "artifact_id": "verification-result:skill-optimizer",
        ...
        "schema_validation": validations["schema_validation"] + [
            {"name": "verification-result schema", "artifact_id": "verification-result:skill-optimizer", "path": str(args.out), "result": "PASS"},
        ],
