...
| --- | --- | --- | --- | --- | --- | --- | --- |
| verification | fresh proving command exits nonzero | `verification-result.json` | block archive | `verification-result.json` | `verification_failed` | `skill-optimizer` | restore previous artifact and rerun verification command |
