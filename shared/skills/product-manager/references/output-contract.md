...
| `docs/{feature}/product-manager-review.md` | 合并三方评审结果、收敛轮次与必要的用户裁决记录 | `references/templates/product-manager-review-template.md` + `references/review-orchestration-contract.md` + `contracts/product-artifacts.yaml#product_manager_review_contract` |
...
- `product-manager-review.md` 是评审闭环证据载体，不能把 review 状态机塞回 `brief.md`。
