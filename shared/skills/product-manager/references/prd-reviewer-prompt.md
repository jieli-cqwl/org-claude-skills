...
| PR-C1 | 共创可信度 | 工件是否保留了真实用户约束与裁决痕迹，而不是 AI 自说自话？ | 只评共创可信度，不要求维护阶段流水账 |
...
|----------|----------|------|------|------|----------|
| PR-001 | WARN | R3 | [具体发现] | [具体 JSON 路径 / 字段 / 值；legacy lane 可给具体文件/章节/内容] | DD-003 / UNIT-002 / `issue_ledger[PR-001]` / `product-manager-review.md#审查问题台账` |
